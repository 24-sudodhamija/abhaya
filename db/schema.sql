...
CREATE TABLE IF NOT EXISTS users (
    ...
    dob VARCHAR(20) DEFAULT '14/08/2003',
    gender VARCHAR(20) DEFAULT 'Female',
    state_region VARCHAR(60) DEFAULT 'Delhi NCR',
...
CREATE TABLE IF NOT EXISTS support_rooms (
    ...
    topic VARCHAR(100),
    description TEXT,
    is_volunteer_led BOOLEAN DEFAULT TRUE,
...
CREATE INDEX IF NOT EXISTS idx_users_lookup ON users(id, is_verified);
...
CREATE INDEX IF NOT EXISTS idx_hazard_category ON hazard_zones(category);
...
CREATE INDEX IF NOT EXISTS idx_support_rooms_active ON support_rooms(is_active) WHERE is_active = TRUE;
